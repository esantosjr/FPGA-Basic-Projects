...
if {![info exists vivado_dir]} { set vivado_dir "Vivado/${project_name}" }
...
# add_files -norecurse -fileset sources_1 [glob -type f -directory src *.edn]
# add_files -norecurse -fileset constrs_1 [glob -type f -directory src/${module} *.xdc]
add_files -norecurse -fileset sources_1 [glob -type f -directory src/${module} *.vhd]
add_files -norecurse -fileset constrs_1 [glob -type f -directory src/${module} *.tcl]
